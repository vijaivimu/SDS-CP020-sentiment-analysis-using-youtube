...
with DAG(
    ...
    POSTGRES_CONN_ID = "my_postgres_connection"  # Make sure this exists in Airflow UI → Connections
    ...
    def create_table():
        ...
        CREATE TABLE IF NOT EXISTS youtube_comments (
            ...
            CONSTRAINT unique_comment_video UNIQUE (comment_id, video_id)  -- Composite key to avoid duplicates
        );
        """
